...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-todo-keyword-faces
        '(
          ("TODO" . (:foreground "#cc6666" :weight bold))
          ("TOREAD" . (:foreground "#5e8d87" :weight bold))
          ("TOWATCH" . (:foreground "#85678f" :weight bold))
          ("TOLISTEN" . (:foreground "#85678f" :weight bold))
          ("INACTIVE" . (:foreground "#707880" :weight bold))
          ("WAITING" . (:foreground "#8abeb7" :weight bold))
          ("STARTED" . (:foreground "#f0c674" :weight bold))
          ("CANCELLED" . (:foreground "#707880" :weight bold))
...
#+BEGIN_SRC emacs-lisp
  (setq org-agenda-custom-commands
        '(
          ...
          ("C" "Coding Projects" tags-tree "coding-TODO=\"DONE\"" ())
          ...
          ;; Special types
          ("z" . "Media")
          ("zr" "To read" todo "TOREAD"
           ((org-agenda-sorting-strategy '(priority-down tag-down))))
          ("zR" "To read - including 'someday'" todo "TOREAD"
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'LaTeX-mode-hook 'spacemacs/toggle-auto-fill-off)
  (add-hook 'LaTeX-mode-hook 'visual-fill-column-mode)
#+END_SRC
* Fira Code
#+BEGIN_SRC emacs-lisp
