...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
        '(
          ...
          ;;  "* TODO %?\n%U\n%c\n" :empty-lines 1)
          ("T" "Todo Today" entry (file+headline "~/Dropbox/org/todo.org" "Inbox")
           "* TODO %?\nSCHEDULED: %t\n%U\n" :empty-lines 1)
          ;; ("l" "Todo with link (e.g. for mail)" entry (file+headline "~/Dropbox/org/todo.org" "Inbox")
          ;;  "* TODO %?\n%U\n%a\n")
          ("l" "link" entry (file+headline "~/Dropbox/org/todo.org" "Inbox")
          ...
          ;;  :empty-lines 1)
          ("c" "org-protocol-capture" entry (file+headline "~/Dropbox/org/todo.org" "Inbox")
