...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
        '(
          ...
          ("N" "Note with Clipboard" entry (file "~/org/inbox.org")
           "* NOTE %?\n%U\n%c\n" :empty-lines 1)
          ("j" "Daily journal" plain (file+olp+datetree "~/org/journal.org")
           "_Zum Vortag:_
  %^{Free-form Reflektion des Vortags}

  _Top-3 Energy Thieves:_
  1. %^{Top-3 Energy Thief}
  2. %^{Top-3 Energy Thief}
  3. %^{Top-3 Energy Thief}

  _Top-3 Energy Givers:_
  1. %^{Top-3 Energy Giver}
  2. %^{Top-3 Energy Giver}
  3. %^{Top-3 Energy Giver}
  ...
  _What am I curious about for today:_
  %^{What am I curious about for today}
  "
