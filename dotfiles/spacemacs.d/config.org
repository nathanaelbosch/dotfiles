...
- [[#other-packages--languages--concepts][Other Packages / Languages / Concepts]]
  ...
  - [[#julia][Julia]]
    ...
    - [[#jupyter-julia-default-org-babel-settings][Jupyter julia default org babel settings]]
        ...
        '(
          ...
          ("p" "Research View"
           ((agenda "" ((org-agenda-span 1)))
            ...
            (tags-todo "Research-project-inactive-REFILE-CANCELLED-WAITING-CATEGORY=\"papers\"-CATEGORY=\"Inbox\""
          ...
          ;;               (org-agenda-dim-blocked-tasks nil)
          ;;               ))
          ;;   (tags-todo "Research-project-REFILE-CANCELLED-WAITING-CATEGORY=\"papers\"-CATEGORY=\"Inbox\""
          ;;              ((org-agenda-overriding-header "All tasks")
          ;;               (org-agenda-todo-ignore-scheduled 'all)
          ;;               (org-agenda-tags-todo-honor-ignore-options t)
          ;;               (org-agenda-todo-ignore-deadlines 'all)
          ...
          ("a" "Standard View"
           ...
           ((org-agenda-filter-preset '("-PhD" "-Research" "-inactive" "-ignore")))
           )
...
#+begin_src emacs-lisp
  (setq org-capture-templates
        (append
         org-capture-templates
         '(("p" "PhD")
           ("pt" "Task" entry (file+headline "~/org/research.org" "Inbox")
            "** TODO %?\n%U" :clock-in t :clock-resume t)
           ...
           ("pj" "Journal" entry (file+olp+datetree "~/org/research_journal.org")
            "* %?\n\nEntered on %U\n%i" :clock-in t :clock-resume t)
           ("pd" "Daily Sketch" entry (file+olp+datetree "~/org/research_journal.org")
            "* Daily Sketch\n*Did:* %^{Did}\n*Struggle:* %^{Struggle}\n*Today:* %^{Today}"
  ...
  (setq org-capture-templates
        (append
         org-capture-templates
         '(("r" "Research")
           ("rt" "Task" entry (file+headline "~/org/research.org" "Inbox")
            "** TODO %?\n%U" :clock-in t :clock-resume t)
           ("rT" "Task (Today)" entry (file+headline "~/org/research.org" "Inbox")
            "** TODO %?\nSCHEDULED: %t\n%U\n" :clock-in t :clock-resume t)
           ("rn" "Note" entry (file+headline "~/org/research.org" "Inbox")
            "** NOTE %?\n%U" :clock-in t :clock-resume t)
           ("re" "Email" entry (file+headline "~/org/research.org" "Inbox")
            "* TODO Email: %a (%:fromname) \n:PROPERTIES:\n:CREATED: %U\n:EMAIL-SOURCE: %l\n:END:\n%U\n"
            :clock-in t :clock-resume t)
           )
         ))
...
#+end_src
*** Jupyter julia default org babel settings
#+begin_src emacs-lisp
