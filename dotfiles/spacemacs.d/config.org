...
#+BEGIN_SRC emacs-lisp
  (setq auto-completion-private-snippets-directory
        '("~/.emacs.d/elpa/25.2/develop/yasnippet-snippets-20190309.1839/snippets"
          ))
#+END_SRC
* Email
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-todo-keyword-faces
        '(("TOREAD" . "#5e8d87")
          ...
          ("STARTED" . "#f0c674")
          ("CANCELLED" . "#707880")
          ("1PASS" . (:foreground "#b5bd68" :weight bold))
          ("2PASS" . (:foreground "#b5bd68" :weight bold))
          ("3PASS" . (:foreground "#b5bd68" :weight bold))
          ("REMINDER" . "#5e8d87")
          ))
#+END_SRC
** Hotkeys
...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
        '(("t" "Todo" entry (file+headline "~/Dropbox/org/todo.org" "Inbox")
           "* TODO %?")
          ("m" "MasterThesis" entry (file+headline "~/Dropbox/org/thesis.org" "Inbox")
           "* TODO %?")
...
#+begin_src emacs-lisp
  (add-to-list 'org-capture-templates
               '("d" "Daily Checkbox" entry
                 (file+olp+datetree "~/Dropbox/org/thesis-journal.org")
                 (file "~/Dropbox/org/templates/daily-thesis-checklist.org"))
               )
  (defun my-daily-checklist-new-entry ()
    (interactive)
    (org-capture nil "d") ;; "dc" is they key I used on org-capture-templates
    (org-capture-finalize t) ;; immediate close the org-capture prompt.
    (display-buffer-other-frame "thesis-journal.org")
    ;; (org-speed-move-safe 'outline-up-heading) ;; move to the buffer with the new daily checklist.
    ;; (org-clock-in) ;; starts the clock on this new daily checklist entry.
    )
#+end_src
** org-agenda
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-agenda-files '("~/Dropbox/org/"
                           ...
                           "~/Projekte/masterthesis-learning-visionbased-control/notes/"
                           "~/Projekte/visual-gp-dynamics/TODOs.org_archive"
                           ))
  ;; (mapcar '(lambda (file)
  ...
  ;;           "~/MEGA/papers/notes.org"
  ;;           "~/Projekte/masterthesis-learning-visionbased-control/notes/"
  ;;           "~/Projekte/masterthesis-learning-visionbased-control/thesis/"
  ;;           )
  ;;         )
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-download-screenshot-method "sleep 3; gnome-screenshot -a -f %s")
