...
- [[#general][General]]
  ...
  - [[#pdf][PDF]]
  - [[#hitting-kj-fast-makes-me-escape-insert-mode][Hitting "kj" fast makes me escape insert mode]]
  - [[#auto-refresh-buffers-when-files-changed-on-disk][Auto-refresh buffers when files changed on disk]]
  - [[#libnotify][libnotify]]
  - [[#visual-line-mode-when-working-with-text-based-content][Visual line mode when working with text based content]]
...
- [[#zetteldeft][Zetteldeft]]
  ...
  - [[#directory][Directory]]
  - [[#ignore-org-mode-metadata][Ignore org-mode metadata]]
- [[#yequake][Yequake]]
- [[#jupyter][Jupyter]]
  - [[#ein][ein]]
